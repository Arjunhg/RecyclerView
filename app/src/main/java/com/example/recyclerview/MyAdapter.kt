...
class MyAdapter(var newsArrayList: ArrayList<news>, var context : Activity) :
    RecyclerView.Adapter<MyAdapter.MyViewHolder>(){ //Every adapter have a sub class called MyViewHolder
    ...
    class MyViewHolder(itemView : View, listener: onItemClickListener) : RecyclerView.ViewHolder(itemView){ //Extending view holder as well
